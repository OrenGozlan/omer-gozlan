...
export const translations = {
  he: {
    ...
    hero: {
      ...
      blurb: 'בגיל 17 בלבד, עומר רושם את עונת השיא שלו: זהב בגביע האומות CEV, זהב באליפות MEVZA U20, אליפות ישראל U18 שלישית ברציפות וארד באליפות ישראל לבוגרים. במקביל הוא עשה את צעדיו הראשונים בסבב המקצועני העולמי (Beach Pro Tour) בסין ובאירופה, הגיע לשמינית הגמר באליפות אירופה U20 (דירוג #9-13) — ובדרך לאליפות אירופה U22.',
    ...
    record: {
      ...
      s2026: [
        ...
        { rank: '1/8', title: 'אליפות אירופה CEV U20 2026', sub: 'שמינית גמר · דירוג סופי #9-13 · באטיפליה, איטליה (מדורג #21)' },
  ...
  en: {
    ...
    record: {
      ...
      s2026: [
        ...
        { rank: '1/8', title: 'CEV U20 European Championship 2026', sub: 'Round of 16 · final placement #9-13 · Battipaglia, Italy (seeded #21)' },
