...
export const translations = {
  he: {
    ...
    hero: {
      ...
      blurb: 'בגיל 17 בלבד, עומר רושם את עונת השיא שלו: זהב בגביע האומות CEV, זהב באליפות MEVZA U20, אליפות ישראל U18 שלישית ברציפות וארד באליפות ישראל לבוגרים. במקביל הוא עשה את צעדיו הראשונים בסבב המקצועני העולמי (Beach Pro Tour) בסין ובאירופה, סיים במקום ה-13 באליפות אירופה U20 — ובדרך לאליפות אירופה U22.',
    ...
    record: {
      ...
      s2026: [
        ...
        { rank: '13', title: 'אליפות אירופה CEV U20 2026', sub: 'מקום 13 מתוך 32 · באטיפליה, איטליה (מדורג #21)' },
  ...
  en: {
    ...
    record: {
      ...
      s2026: [
        ...
        { rank: '13', title: 'CEV U20 European Championship 2026', sub: '13th of 32 · Battipaglia, Italy (seeded #21)' },
