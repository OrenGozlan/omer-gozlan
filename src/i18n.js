...
export const translations = {
  he: {
    ...
    hero: {
      ...
      blurb: 'בגיל 17 בלבד, עומר רושם את עונת השיא שלו: זהב בגביע האומות CEV, זהב באליפות MEVZA U20, אליפות ישראל U18 שלישית ברציפות וארד באליפות ישראל לבוגרים. במקביל הוא עשה את צעדיו הראשונים בסבב המקצועני העולמי (Beach Pro Tour) בסין ובאירופה, הגיע ל-1/8 הגמר באליפות אירופה U20 (דירוג #9-13) — וסיים במקום התשיעי באליפות אירופה U22 במדריד, בגיל 17 מול שחקנים בני 21-22.',
